...
class _CryptoCoinScreenState extends State<CryptoCoinScreen> {
  ...
  final _coinDetailsBloc = CryptoCoinDetailsBloc(GetIt.I<AbstractCoinsRepository>());

  @override
  void initState() {
      _coinDetailsBloc.add(LoadCryptoCoinDetailsEvent(currencyCode: widget.coin.name));
    super.initState();
  }
  ...
  //   _coinDetailsBloc.add(LoadCryptoCoinDetailsEvent(currencyCode: coin!.name));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<CryptoCoinDetailsBloc, CryptoCoinDetailsState>(
        ...
        builder: (BuildContext context, CryptoCoinDetailsState state) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(coin.name, style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700)),
                  const SizedBox(height: 8),
                  BaseCard(
                      child: Center(
                          child: Text('${coinDetails.priceInUSD} \$', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w700)))),
                  BaseCard(
                    child: Column(
                      children: [
                        _DataRow(
